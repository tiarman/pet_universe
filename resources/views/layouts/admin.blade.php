    ...
    <div id="wrapper">
        ...
        <div class="left side-menu">
                    ...
                    <ul>
                        ...
                        @if (
                            \App\Helper\CustomHelper::canView(
                                'Create Slider|Manage Slider|Delete Slider|View Slider|List Of Slider',
                                'Super Admin'))
                            <li class="has_sub">
                                <a class="waves-effect"><i class="mdi mdi-airplay"></i><span> Sliders <span
                                            class="pull-right"><i class="mdi mdi-chevron-right"></i></span> </span></a>
                                <ul class="list-unstyled">
                                    @if (\App\Helper\CustomHelper::canView('Create Slider', 'Super Admin'))
                                        <li><a href="{{ route('slider.create') }}">Create new</a></li>
                                    @endif

                                    @if (\App\Helper\CustomHelper::canView('Manage Slider|Delete Slider|View Slider|List Of Slider', 'Super Admin'))
                        ...
                        {{--  @if (\App\Helper\CustomHelper::canView('Create Category|Manage Category|Delete Category|View Category|List Of Category|Store Category', 'Super Admin'))
          <li class="has_sub">
              <a class="waves-effect"><i class="mdi mdi-airplay"></i><span> Category <span
                          class="pull-right"><i class="mdi mdi-chevron-right"></i></span> </span></a>
              <ul class="list-unstyled">
                  @if (\App\Helper\CustomHelper::canView('Create Category', 'Super Admin'))
                  <li><a href="{{route('category.create')}}">Create new</a></li>
                  @endif
                      @if (\App\Helper\CustomHelper::canView('Manage Category|Delete Category|View Category|List Of Category', 'Super Admin'))
          ...
          @endif  --}}
                        ...
                        @if (
                            \App\Helper\CustomHelper::canView(
                                'Create Category|Manage Category|Delete Category|View Category|List Of Category|Store Category',
                                'Super Admin'))

                            <li>
                                @if (\App\Helper\CustomHelper::canView('Create Category', 'Super Admin'))
                                    <a href="{{ route('category.list') }}" class="waves-effect"><i
                                            class="mdi mdi-view-agenda"></i> <span> Category</span>
                                    </a>
                                @endif
                            </li>
                        ...
                        {{--  @if (\App\Helper\CustomHelper::canView('Create Sub Category|Manage Sub Category|Delete Sub Category|View Sub Category|List Of Sub Category', 'Super Admin'))
          <li class="has_sub">
              <a class="waves-effect"><i class="mdi mdi-airplay"></i><span>Sub Category <span
                          class="pull-right"><i class="mdi mdi-chevron-right"></i></span> </span></a>
              <ul class="list-unstyled">
                  @if (\App\Helper\CustomHelper::canView('Create Sub Category', 'Super Admin'))
                  <li><a href="{{route('admin.subcategory.create')}}">Create new</a></li>
                  @endif
                      @if (\App\Helper\CustomHelper::canView('Manage Sub Category|Delete Sub Category|View Sub Category|List Of Sub Category', 'Super Admin'))
                      <li><a href="{{route('admin.subcategory.list')}}">List of Sub Category</a></li>
                      @endif
              </ul>
          </li>
          @endif  --}}
        ...
        <div class="content-page">
            ...
            <footer class="footer">
                ...
                <span class="text-muted hidden-xs-down pull-right">Developed & Maintained by <a href="#"
                        target="_blank">PET UNIVERSE</a></span>
            </footer>
        </div>
    </div>
