                ...
                <div class="card-body">
                    <section class="panel">
                        <header class="panel-heading">
                            <h2 class="panel-title">List of Food</h2>
                        </header>
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-xl-12 text-right mb-3">
                                    <a href="{{ route('food.create_store') }}" class="brn btn-success btn-sm">New Food</a>
                                </div>
                            </div>
                                ...
                                <tbody>
                                    @foreach ($foods as $key => $val)
                                        <tr class="@if ($key % 2 == 0) gradeX @else gradeC @endif">
                                            ...
                                            <td class="p-1"><img src="{{ asset($val->img) }}" style="height: 50px;">
                                            </td>
                                            ...
                                            <td class="text-capitalize p-1" width="100">
                                                <div class="onoffswitch">
                                                    <input type="checkbox" name="onoffswitch" class="onoffswitch-checkbox"
                                                        @if ($val->status == \App\Models\Food::$statusArray[0]) checked @endif
                                                        data-id="{{ $val->id }}" id="myonoffswitch{{ $key + 1 }}">
                                            ...
                                            <td class="center hidden-phone p-1" width="100">
                                                <a href="{{ route('animal.manage', $val->id) }}"
                                                    class="btn btn-sm btn-success"> <i class="fa fa-edit"></i> </a>
                                                <span class="btn btn-sm btn-danger btn-delete delete_{{ $val->id }}"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <strong>Are You Sure Delete Food</strong>
                </div>
